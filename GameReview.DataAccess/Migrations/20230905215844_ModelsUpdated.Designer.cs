...
namespace GameReview.DataAccess.Migrations
{
    ...
    [Migration("20230905215844_ModelsUpdated")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameReview.Data.Models.Entity.Review", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        ...
                        .HasDefaultValue(new DateTime(2023, 9, 5, 18, 58, 44, 189, DateTimeKind.Local).AddTicks(9735));
            ...
            modelBuilder.Entity("GameReview.Data.Models.Security.Module", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameReview.Data.Models.Security.Operation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameReview.Data.Models.Security.Rol", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameReview.Data.Models.Security.RolOperation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameReview.Data.Models.Entity.User", b =>
                {
                    b.HasOne("GameReview.Data.Models.Security.Rol", "Rol")
                        .WithMany()
                        .HasForeignKey("RolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GameReview.Data.Models.Security.Operation", b =>
                {
                    b.HasOne("GameReview.Data.Models.Security.Module", "Module")
                        .WithMany()
            ...
            modelBuilder.Entity("GameReview.Data.Models.Security.RolOperation", b =>
                {
                    b.HasOne("GameReview.Data.Models.Security.Operation", "Operation")
                        .WithMany()
